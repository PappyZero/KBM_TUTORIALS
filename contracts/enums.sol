...
contract Ether_Wallet {
    ...
    function setUserProfile(address _addr, string memory _name) public {
    ...
    function withdraw(address _addr, uint256 _amount) payable public updateTransactionState(_amount <= MAX_WITHDRAWAL && userProfiles[_addr].balance >= _amount) {
